...
- [DevJacob_AudioManager](https://github.com/DevJacob-Studios/DevJacob_AudioManager)

### Installation
Installing the resource is simple, just download the latest version from the [releases](https://github.com/DevJacob-Studios/DevJacob_Fuel/releases/latest) tab, place the folder into your FiveM resources folder and then add `ensure DevJacob_Fuel` to your server.cfg file.
